...
# 10 non-overlapping ensembles of 5 candidates each: seeds 1-5, 6-10, ..., 46-50
ENSEMBLE_BASES=(1 6 11 16 21 26 31 36 41 46)
CONSENSUS_N=5
CKPT="grasp_6dof/models/cfm_allobj_ot.pt"

RESULTS="/home/lina/.claude/jobs/b899ad73/tmp/phase1_pilot/consensus_trials_n10.jsonl"
