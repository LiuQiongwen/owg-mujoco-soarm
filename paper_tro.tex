...
include a statistically tested ledger of eleven ruled-out mechanisms for
a separate, still-open execution-reliability problem, and a
hardware-deployment architecture with a pre-validation safety checklist.
