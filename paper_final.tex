...
\noindent\textbf{Not fully swept; one check finds Pear specifically
fragile.} Stratified-OT's failure to move Pear at all, unlike its partial
recovery of TomatoSoupCan/CrackerBox, may reflect Pear's smaller training
set (248 positives, fewest of all 7) rather than a limit of the approach.
A stronger EBM v2 hard-negative-mining schedule reproduces TomatoSoupCan/
CrackerBox exactly (100\%/28\%) but drops Pear 72\%$\to$48\% (ns at
$n{=}25$, McNemar $p{=}0.15$) -- again Pear, again the least data.
