#!/usr/bin/env python3
"""
Paired Statistical Analysis — TANGO Stage-3 vs Stage-4 experiments
...
def main():
    ...
    print("# Paired Statistical Analysis — TANGO Stage-3 vs Stage-4\n")
...
def write_stats_summary(all_rows, pwr_rows, pairs_all):
    ...
    md = []
    md.append("# TANGO Stage-4 LGGSN — Statistical Summary\n")
