#!/usr/bin/env python3
"""
LGGSN v8 — geometry + SAM visual feature (concatenation).
...
JSONL_PATH = os.environ.get(
    "LGGSN_JSONL", "grasp_6dof/dataset/lggsn_candidates_v8.jsonl"
)
CKPT_PATH  = os.environ.get(
    "LGGSN_CKPT",  "grasp_6dof/models/lggsn_pairwise_live_v8.pt"
)
...
def load_episodes(path: str) -> dict:
    """
    Read v8 JSONL. Group by (query, scene_id).
